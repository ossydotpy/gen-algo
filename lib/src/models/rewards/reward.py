...
class Rewards:
    ...
    def calculate_total_reward(self, individual: Individual, preferences: Dict, subjects: List[str], time_slots: List[str]) -> float:
        total_reward = 0.0
        for reward in self.rewards:
            total_reward += reward.calculate(individual, preferences, subjects, time_slots) * reward.weight
        return total_reward